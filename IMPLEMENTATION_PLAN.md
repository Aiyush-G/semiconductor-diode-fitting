...
**Tasks:**
- [x] Implement single diode equivalent circuit equations
- [x] Implement light-generated current (linear region)
- [x] Implement diode curve region + series/shunt resistance effects
